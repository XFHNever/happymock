 ...
 * Date: 14-8-22
 */
public class UriCompiler implements com.ebay.happymock.core.compiling.v1.Compiler {
    ...
    @Override
    public com.ebay.happymock.core.compiling.v1.Compiler locateChild(String keyword) {
        return null;
    }
}
