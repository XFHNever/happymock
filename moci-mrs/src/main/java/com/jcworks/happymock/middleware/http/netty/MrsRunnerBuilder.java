...
import com.jcworks.happymock.core.HappyMockEngine;
import com.jcworks.happymock.persist.dao.impl.MongoConn;
...
public final class MrsRunnerBuilder {
    ...
    public MrsRunnerBuilder withTraceLevel(String level){
        LogManager.getLogger("com.jcworks.happymock").setLevel(org.apache.log4j.Level.toLevel(level));
