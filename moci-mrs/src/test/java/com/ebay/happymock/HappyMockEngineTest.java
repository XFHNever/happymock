...
import static com.ebay.happymock.core.entity.Request.RequestBuilder.newRequest;
...
public class HappyMockEngineTest {
    ...
    void testMock() throws Exception {
        String file=System.getProperty("user.dir")+File.separator+"src"+File.separator+"test"+File.separator+"java"+File.separator+"com"+File.separator+"ebay"+File.separator+"happymock"+File.separator+"persist"+File.separator+"service"+File.separator+"moci.dsl";
